...
public class Main extends ApplicationAdapter {
    ...
    private String assets = "lib/ui/Soldier/";
    
    @Override
    public void create() {
        stage = new Stage(new ScreenViewport());
        skin = new Skin(Gdx.files.internal(assets + "star-soldier-ui.json"));
        ...
        Node node = new TNode(new Label("Star", skin));
        tree.add(node);
        
        Node subNode = new TNode(new Label("Solder", skin));
        node.add(subNode);
        node = subNode;
        
        subNode = new TNode(new Label("UI", skin));
        node.add(subNode);
        node = subNode;
        
        subNode = new TNode(new Label("It doesn't matter when it's Arcturian, baby.", skin));
        node.add(subNode);
        node = subNode;
        
        subNode = new TNode(new Label("It's game over, man!", skin));
        node.add(subNode);
        node = subNode;
        
        subNode = new TNode(new Label("It's game over!", skin));
        node.add(subNode);
        node = subNode;
        tree.expandAll();
        table.add(tree);
